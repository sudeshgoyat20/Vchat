...
function writeBundleFilesToDisk(context) {
    ...
    var promises = bundledFilesToWrite.map(function (bundledFileToWrite) { return helpers_1.writeFileAsync(bundledFileToWrite.path, bundledFileToWrite.content); });
    return Promise.all(promises);
}
exports.writeBundleFilesToDisk = writeBundleFilesToDisk;
